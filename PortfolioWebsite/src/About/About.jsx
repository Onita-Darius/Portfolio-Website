...
ratio using Python through a API(FastAPI) .</p>
            <p>You can currently reach find some of my projects on my <a href="/Projects">Projects</a> page or on my <a href="https://github.com/Onita-Darius" target="_blank" rel="noopener noreferrer">GitHub profile</a>.
